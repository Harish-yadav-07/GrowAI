...
export default function ResumeBuilder({ initialContent }) {
  ...
  const convertOklchToHexForPDF = (container) => {
    ...
    const colorMap = {
      ...
      "oklch(0.577 0.245 27.325)": "#e11d48",
      "oklch(0.704 0.191 22.216)": "#fb7185",
    };
    ...
    allElements.forEach((el) => {
      ...
      el.style.color = convertValue(computed.color);
      el.style.backgroundColor = convertValue(computed.backgroundColor);
      el.style.borderColor = convertValue(computed.borderColor);
      el.style.outlineColor = convertValue(computed.outlineColor);
  ...
  const generatePDF = async () => {
    ...
    try {
      ...
      // FORCE SAFE COLORS ONLY INSIDE PDF
      wrapper.innerHTML = `
      <style>
        * {
  ...
  return (
    <div data-color-mode="light" className="space-y-4 relative">
      ...
      {/* FIX: Move PDF element OUTSIDE of TabsContent so it is always in DOM */}
      <div
        style={{
          position: "absolute",
          left: "-9999px",
      ...
      >
        <div id="resume-pdf" className="p-8">
          <MDEditor.Markdown
